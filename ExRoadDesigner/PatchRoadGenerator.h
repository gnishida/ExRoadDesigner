...
private:
	...
	bool growRoadSegment(int roadType, RoadVertexDesc srcDesc, ExFeature& f, float length, int num_steps, float angle, float curvature, int lanes, float angleTolerance, std::list<RoadVertexDesc> &seeds);
