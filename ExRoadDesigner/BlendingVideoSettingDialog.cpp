...
BlendingVideoSettingDialog::BlendingVideoSettingDialog(MainWindow* mainWin) : QDialog((QWidget*)mainWin) {
...
void BlendingVideoSettingDialog::onOK() {
...
void BlendingVideoSettingDialog::onCancel() {
	reject();
}
