...
**
** Created: Wed Jun 17 12:12:01 2015
...
public:
    ...
    QAction *actionLoadArea;
    QAction *actionCreateArea;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionLoadArea = new QAction(MainWindow);
        actionLoadArea->setObjectName(QString::fromUtf8("actionLoadArea"));
        actionCreateArea = new QAction(MainWindow);
        actionCreateArea->setObjectName(QString::fromUtf8("actionCreateArea"));
        ...
        menuFile->addAction(actionLoadArea);
        menuFile->addSeparator();
        menuFile->addAction(actionExit);
        menuWindow->addAction(actionControlWidget);
        menuArea->addAction(actionCreateArea);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionLoadArea->setText(QApplication::translate("MainWindow", "Load Area", 0, QApplication::UnicodeUTF8));
        actionLoadArea->setShortcut(QApplication::translate("MainWindow", "Ctrl+A", 0, QApplication::UnicodeUTF8));
        actionCreateArea->setText(QApplication::translate("MainWindow", "Create Area", 0, QApplication::UnicodeUTF8));
